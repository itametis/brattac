 ...
 * @param {Object} B
 *          The package into which place this framework, generally the "window" variable provided by browsers but can be
 *          "this" too.
...
(function(THIS, B, undefined) {
    "use strict";
    /**
     * This function is a kind of helper making easier the "Class" definition in JavaScript. The goal is to provide a
     * way more compliant with the Java Oriented-Object syntax grouping all methods, constructor and attributes inside
     * the same declaration. Moreover, the goal is to hide the prototype method declaration complexity to the Java
     * developer by ensuring this point is always correctly done ; and keep the encapsulation principle safe.<br />
     * <br />
     * <b>Usage :</b>
     * <pre>
     *      <code>
     ...
     *
     * @return A prototype of the class to define.
     */
    ...
    /**
     * Adds all constants declared inside the "constants" attribute of the JSON declaration, as constants of the
     * prototype of the class in creation.
     *
     * @param {JSON} body
    ...
    /**
     * Adds all functions declared inside the "methods" attributes of the JSON declaration to the prototype of the class
     * in creation.
     *
     * @param {JSON} body
     *          The JSON declaration of all methods to add to the prototype of the class in creation.
    ...
    /**
     * Adds the parent keywork into the prototype of the specified class.
     *
     * @param parentProto
     *          The parent.prototype object.
     * @param c
     *          The class into which the parent's prototype should be defined as 'c.prototype.parent'.
     */
    ...
    /**
     * Adds all functions declared inside the "static_methods" attribute of the JSON declaration, as static methods of
     * the prototype of the class in creation.
     *
     * @param {JSON} body
     *          The JSON declaration of all methods to add to the prototype of the class in creation.
     */
    ...
    /**
     * Returns the reference of a prototype from the string of his path. For instance, returns the reference to the
     * object Person by giving the string "com.itametis.Person".
     *
     * @param {String} path
     *          The canonical path of a class.
     *
     * @return {Object} The reference to the object target by the given path.
     */
     ...
     *
     * @return {Boolean} true if the body declaration contains invalid names, false otherwise.
     */
     ...
     *
     * @param {JSON} body
     *          The JSON declaration containing the attribute "inherits" to set as parent prototype of the prototype in
     *          creation.
     */
     ...
     *
     * @return {Function} The constructor of the class to build.
     */
     ...
     *
     * @return {Object} The namespace built by the method.
     */
    ...
    /**
     * Determines whether or not, the keyword given in parameter is inside the list of the ones defined by this
     * framework.
     *
     * @param {String} keyword
     *          The keyword name to research inside of the autorized keywords list.
     *
     * @return {Boolean} true if the specified keyword is invalid, false otherwise.
     */
     ...
     *
     * @return {Boolean} true if the element exits, false otherwise.
     */
